...
I was on the Bechtel COUCH committee to figure out what life would look like there - so I'm pretty experienced dealing with admin...
...
Very crusty now - time flies - but a massive sucker if you ever want a hand with your Ditch Day stack or *anything* else.
...
([source](https://github.com/tgorordo/discord-lightsout) -- needs a rewrite, ping me if you have questions in the meantime)
...
for the ultimate negative-time roadtrip challenge. (needs an update -- ping me if you have questions in the meantime.

# TITANIC HAS SUNK
This repo is defunct as a result. Hopefully titanic comes back someday.
